...
import com.plcs.web.common.security.Digests;
import com.plcs.web.common.security.shiro.session.SessionDAO;
import com.plcs.web.common.service.BaseService;
import com.plcs.web.common.service.ServiceException;
...
import com.plcs.web.common.web.Servlets;
import com.plcs.web.modules.sys.bo.UserBO;
import com.plcs.web.modules.sys.dao.MenuDao;
import com.plcs.web.modules.sys.dao.RoleDao;
import com.plcs.web.modules.sys.dao.UserDao;
import com.plcs.web.modules.sys.entity.Menu;
...
import com.plcs.web.modules.sys.security.SystemAuthorizingRealm;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public ResultVO<List<UserBO>> getUserByRole(String roleId){
		ResultVO<List<UserBO>> resultVO = new ResultVO<>();
		try{
			resultVO.setResult(userDao.selectUserByRole(roleId));
			resultVO.setSuccess(true);
		} catch (Exception e){
			logger.error(SystemService.class.getName(),"getUserByRole",e.getMessage(),e);
			resultVO.setError(AllocateGroupConstants.GET_USER_BY_ROLE_FAILED,"获取用户列表信息失败");
		}
		return resultVO;
	}
